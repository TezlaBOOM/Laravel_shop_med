...
class FlashSaleItemDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('Nazwa', function($query){
                return "<a href='".route('admin.product.edit', $query->product->id)."'>".$query->product->name."</a>";
            })
            ->addColumn('SKU', function($query){
                return "<a href='".route('admin.product.edit', $query->product->id)."'>".$query->product->sku."</a>";
            })
            ...
            ->addColumn('Wyswietlanie', function($query){
            ...
            ->rawColumns(['status', 'Wyswietlanie', 'action', 'Nazwa', 'SKU'])
            ->setRowId('id');
    }
