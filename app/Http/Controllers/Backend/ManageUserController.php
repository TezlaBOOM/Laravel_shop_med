...
class ManageUserController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if($request->role === 'user'){
            ...
            toastr('Stworzono', 'success', 'success');
            ...
            $vendor->shop_name = $request->name.' Sklep';
            $vendor->phone = '12321312';
            $vendor->nip = '000000000';
            $vendor->email = 'Nowo_dodany@tezla.pl';
            $vendor->address = 'PLN';
            $vendor->description = 'Opis sklepu.';
