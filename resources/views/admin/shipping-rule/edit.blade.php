                    ...
                    <form action="{{route('admin.shipping-rule.update', $shipping->id)}}"  method="POST">
                        ...
                        <div class="form-group">
                          ...
                          <select id="inputState" class="form-control shipping-type" name="type">
                            <option {{$shipping->type === 'flat_cost' ? 'selected' : ''}} value="flat_cost">Stały koszt</option>
                            <option {{$shipping->type === 'min_cost' ? 'selected' : ''}} value="min_cost">Minimalna koszt zamówienia</option>                          
                          </select>
                      </div>

                      <div class="form-group {{$shipping->type === 'min_cost' ? '' : 'd-none'}}"">
                       ...
                       <input type="text" class="form-control" name="cost" value="{{$shipping->cost}}">
                        ...
                        <div class="form-group">
                            ...
                            <select id="inputState" class="form-control" name="status">
                              <option {{$shipping->status === 1 ? 'selected' : ''}} value="1">Aktywny</option>
                              <option {{$shipping->status === 0 ? 'selected' : ''}}  value="0">Nie aktywny</option>
                            </select>
                        </div>
