                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-md">
                                    ...
                                    @foreach ($order->orderProducts as $product)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @foreach ($variant as $key => $variantt)
                                                    ...
                                                    @break
                                                @endif
                                                <b>{{ $key }}:</b> {{ @$variantt->name }} (
                                                {{ @$variantt->price }} {{ $settings->currency_icon }})<br>
                                            @endforeach
                                        </td>
                                                    ...
                                                    @foreach ($backorders as $backordered)
                                                        @if ($variantt->backorder == $backordered->id)
                                                            @if ($variantt->storage - $product->qty > 0)
                                                                <b>Dostępne</b>
                                                            @else
                                                                <b>{{ $backordered->name }}: brakuje
                                                                    {{ $variantt->storage - $product->qty }} z
                                                                    {{ $variantt->storage }} </b>
                                                                @dd($backordered->id);
                                                            @endif
                                        ...
                                        <td class="text-right">
                                            {{ $product->unit_price * $product->qty + $product->variant_total * $product->qty }}
                                            {{ $settings->currency_icon }}</td>
                                    </tr>
                                @endforeach
