            ...
            <form action="{{route('admin.homepage-banner-secion-two')}}" method="POST" enctype="multipart/form-data">
                ...
                @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" name="banner_one_banner_old_image" value="{{@$homepage_secion_banner_two->banner_one->banner_image}}">
                    </div>
                    <div class="form-group">
                        <label>Banner url</label>
                        <input type="text" class="form-control" name="banner_one_banner_url" value="{{@$homepage_secion_banner_two->banner_one->banner_url}}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" name="banner_two_banner_old_image" value="{{@$homepage_secion_banner_two->banner_two->banner_image}}">
                    </div>
                    <div class="form-group">
                        <label>Banner url</label>
                        <input type="text" class="form-control" name="banner_two_banner_url" value="{{@$homepage_secion_banner_two->banner_two->banner_url}}">
                    </div>
