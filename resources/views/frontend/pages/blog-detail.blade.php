                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:;">Blog Post</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xxl-9 col-xl-8 col-lg-8">
                    <div class="wsus__main_blog">
                        ...
                        <p class="wsus__main_blog_header">
                            <span><i class="fas fa-user-tie"></i> dodane przez {{$blog->user->name}}</span>
                        ...
                        <div class="wsus__comment_area">
                            <h4>Komętarze <span>{{count($comments)}}</span></h4>
                            ...
                            @endforeach
                            @if (count($comments) === 0)
                             <i>Bądź pierwszym komentującym </i>
                            @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="wsus__single_com">
                                            <textarea rows="5" placeholder="Twój komentarz" name="comment"></textarea>
                                            <input type="hidden" name="blog_id" value="{{$blog->id}}">
                                        </div>
                                    </div>
                                </div>
                                <button class="common_btn" type="submit">Dodaj komentarz</button>
                            </form>
                            @else
                            <p>Zaloguj się aby skomentować post</p>
                        ...
                        <div class="wsus__blog_post">
                            ...
                            <div class="wsus__blog_post_single">
                                ...
                                <div class="wsus__blog_post_text">
                                    ...
                                    <p> <span>{{date('M d Y', strtotime($blog->created_at))}} </span> {{count($blog->comments)}} Komentarze </p>
                                </div>
                            </div>
                            @endforeach
