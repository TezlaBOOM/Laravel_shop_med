                ...
                <div class="row">
                        ...
                        <div class="wsus__payment_menu" id="sticky_sidebar">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                {{-- <button class="nav-link common_btn active" id="v-pills-home-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="v-pills-stripe" aria-selected="false">Płatność za pobraniem</button>
    
                                    <button class="nav-link common_btn" id="v-pills-profile-tab" data-bs-toggle="pill"
                                    data-bs-target="#v-pills-customer-credit" type="button" role="tab"
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="tab-content" id="v-pills-tabContent" id="sticky_sidebar">
                                ...
                                <div class="row">
                                    <div class="col-xl-12 m-auto">
                                        <div class="wsus__payment_area">
                                            <a class="nav-link common_btn text-center" href="{{route('user.paypal.payment')}}">Zapłać Paypal</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            @include('frontend.pages.payment-gateway.customer-credit')
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="wsus__pay_booking_summary" id="sticky_sidebar2">
                            <h5>Podsumowanie</h5>
                            <p>Produkty: <span>{{getCartTotal()}} {{$settings->currency_icon}}</span></p>
                            <p>Dostawa: <span>{{getShppingFee()}} {{$settings->currency_icon}}</span></p>
                            <p>Kupon: <span>{{getCartDiscount()}} {{$settings->currency_icon}}</span></p>
                            <h6>Suma: <span>{{getFinalPayableAmount()}} {{$settings->currency_icon}}</span></h6>
                        </div>
                    </div>
                </div>
            </div>
