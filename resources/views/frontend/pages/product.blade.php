            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="wsus__pro_page_bammer">
                        @if ($product_banner->banner_one->status == 1)
                        <a href="{{$product_banner->banner_one->banner_url}}">
                            <img class="img-gluid" src="{{asset($product_banner->banner_one->banner_image)}}" alt="">
                        </a>
                        @endif
                    </div>
                </div>
