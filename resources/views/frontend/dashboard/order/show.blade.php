                          ...
                          <div class="">
                              <div class="wsus__invoice_area">
                                  ...
                                  <div class="wsus__invoice_footer">
                                    ...
                                    <p><span>Cena:</span> {{@$order->sub_total}} {{ @$settings->currency_icon }} </p>
                                    <p><span>Dostawa:</span>{{@$shipping->cost}} {{ @$settings->currency_icon }} </p>
                                    <p><span>Kupon:</span>{{@$coupon->discount ? $coupon->discount : 0}} {{ @$settings->currency_icon }} </p>
                                    <p><span>Całość:</span>{{@$order->amount}} {{ @$settings->currency_icon }}</p>
                          </div>
                              </div>
                          </div>
                      </section>
